...
<div class="container-bookList mt-4" align="center">
	...
	<div class="row justify-content-between">
		<div class="bookList-icon text-center">
			<img src="/image/icon/icon-book.png">
			<h5>
				<strong>도서 목록</strong>
			</h5>
		</div>
	...
	<div class="mt-3"
		style="border-top: 7px solid #205295; padding-top: 20px">
				...
				<div class="col-md-2 buttons">
					...
					<c:choose>
						<c:when test="${interestedBookMap[book] ne null}">
							<button
								class="btn-removeInterest btn btn-outline-secondary custom-button"
								style="font-size: 11px; width: 90px; height: 33.2px; padding: 4.1px 6px;"
								data-booknum="${book.bookNum }">
								<img src="/image/fillheart.png"
									style="width: 25px; height: 25px">
							</button>
						</c:when>
						<c:otherwise>
							<button
								class="btn-addInterest btn btn-outline-secondary custom-button"
								style="font-size: 11px; width: 90px; height: 33.2px; padding: 4.1px 6px;"
								data-booknum="${book.bookNum }">
